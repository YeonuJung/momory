    ...
    <>
      ...
      <div className="flex flex-col gap-y-[5.2vw] xs:gap-y-[2.25rem]">
        ...
        <div className="flex flex-col items-center justify-center">
          <h2 className="w-[72.08vw] font-pretendard text-[3.7vw] font-normal tracking-tight text-white xs:w-[32.58rem] xs:text-[1.62rem]">
            <span className="font-semibold">
              내 모모리 비밀번호를 아는 친구만 입장
            </span>
            할 수 있어요!
          </h2>
          <h2 className="flex w-[72.08vw] justify-center font-pretendard text-[3.7vw] font-normal tracking-tight text-white xs:w-[32.58rem] xs:text-[1.62rem]">
            비밀번호를 꼭 기억해주세요
          </h2>
        </div>
      </div>
